        ...
        return c = createjs, b = "", M = "", x = t.innerWidth, Y = t.innerHeight, o = 600, X = 1200, u = 0, p = 0, n = Math.PI, a = 2 * n, C = !1, l = function(t) {
                ...
                return i(e, t), r = 32, s = 800, h = a / r, T = new c.Matrix2D, P = new c.Matrix2D, m = new c.Shape, p = [], v = [], f = [], w = [], u = [], e.prototype.init = function() {
                    ...
                    for (m.graphics.clear(), this.velocityX = this.targetValueX - this.angleX, this.angleX += this.velocityX, this.velocityY = this.targetValueY - this.angleY, this.angleY += this.velocityY, T.identity()
                        .rotate(this.velocityX), P.identity().rotate(this.velocityY), a = u = 0; r >= 0 ? r > u : u > r; a = r >= 0 ? ++u : --u) t = p[a], i = v[a], e = f[a], o = w[a], t.setMatrix(T, "x", s), i.setMatrix(T, "x", s), e.setMatrix(T, "x", s), o.setMatrix(T, "x", s), t.setMatrix(P, "y", s), i.setMatrix(P, "y", s), e.setMatrix(P, "y", s), o.setMatrix(P, "y", s);
                ...
                return i(a, t), b = 231, Z = 0, C = "first", x = !0, S = !0, d = $("#JsFirstBlock"), os = $("#JsOverseaBlock"), y = $("#JsMissionBlock"), l = $("#JsActionBlock"), T = $("#JsSolutionBlock"), h = $("#JsCompanyBlock"), w = $("#JsRecruitBlock"), X = ["#da1f3e", "#f58345", "#fdee21", "#8cc63e", "#15a2c0", "#006181", "#662e91"], Y = !1, M = function(t, i, e, o) {
                    ...
                    for (n = e.createElement("canvas"), o = n.getContext("2d"), s = 0, p = 0, d = 10, l = t.target, n.width = l.width, n.height = l.height, h = l.width, u = l.height, r = h / 2, a = u / 2, y = f = 0; d > 0 ? h > f : f > h; y = f += d)
                        for (v = w = 0; d > 0 ? u > w : w > u; v = w += d)
                    ...
                    //     for (o = this.Spiral, o.scaleX = 0, o.scaleY = 0, this.addChild(o), o.show(this.inFirstBlock.bind(this)), i = n = 0; b >= 0 ? b > n : n > b; i = b >= 0 ? ++n :
                    ...
                    var t, i, e;
                    for (S = !1, Z = b, this.Spiral.goToOversea(), t = e = 0; b >= 0 ? b > e : e > b; t = b >= 0 ? ++e : --e) i = this.Particles.all[t], this.Particles.all[t].goToOversea(this.showElmOversea.bind(this), t)
